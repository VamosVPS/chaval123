...
"""
        ...
        if target_user:
            ...
            # Lógica para owners
                if unidad == 'd':
                    current_premium_end = parse_date(user_data["premium_end"]) if user_data["premium_end"] else datetime.now()
                    ...
                    if parsed_premium_end_date:  # Ensure the date was parsed successfully
                        ...
                        if parsed_premium_end_date <= current_date:
                            if data["warnings"] < 3:
                                ...
                                update_user_data(username, data)  # Save updated user data
                                notification_message = (
                            ...
                            try:
                                ...
                                print(f"Error: No se puede enviar un mensaje al grupo {notification_chat_id}. "
